...
<?php $__env->startSection('cuadrado'); ?>
	...
	<form action="" class="cajita">
		<fieldset>
			...
			<div class="destino">
				<img class="alexmoscu2" src="<?php echo e(asset('images/madrid.jpg')); ?>">
				<p class= "texto">
		...
		<div class="destino">
			<img class="alexmoscu2" src="<?php echo e(asset('images/quito.jpg')); ?>">
				<p class= "texto">
		...
		<legend class="topics1">TURKEY</legend>
			<div class="destino">
				<img class="alexmoscu2" src="<?php echo e(asset('images/turquia.jpg')); ?>">
		...
		<legend class="topics1" >MOSCOW</legend>
			<div class="destino">
			<img class="alexmoscu2" src="<?php echo e(asset('images/moscu.jpg')); ?>">
				<p class= "texto">
		...
		<legend class="topics1">PARIS</legend>
			<div class="destino">
				<img class="alexmoscu2" src="<?php echo e(asset('images/paris.jpg')); ?>">
		...
		<legend class="topics1">MALLORCA</legend>
			<div class="destino">
				<img class="alexmoscu2" src="<?php echo e(asset('images/mallorca.jpg')); ?>">
		...
		<legend class="topics1">RIO OF JANEIRO</legend>
			<div class="destino">
				<img class="alexmoscu2" src="<?php echo e(asset('images/brasil.jpg')); ?>">
...
<?php echo $__env->make('navegador', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/mynameistravel/resources/views/destination.blade.php ENDPATH**/ ?>