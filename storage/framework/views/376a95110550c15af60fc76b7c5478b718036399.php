...
<?php $__env->startSection('imagetopics'); ?>

	<div class="imagen123">	

		<input type="image" class="alexmoscu1" src="<?php echo e(asset('images/madrid.jpg')); ?>">
		<input type="image" class="alexmoscu1" src="<?php echo e(asset('images/quito.jpg')); ?>" >
		<input type="image" class="alexmoscu1" src="<?php echo e(asset('images/turquia.jpg')); ?>">
		<input type="image" class="alexmoscu1" src="<?php echo e(asset('images/moscu.jpg')); ?>">
		<input type="image" class="alexmoscu1" src="<?php echo e(asset('images/paris.jpg')); ?>">
		<input type="image" class="alexmoscu1" src="<?php echo e(asset('images/mallorca.jpg')); ?>">
		<input type="image" class="alexmoscu1" src="<?php echo e(asset('images/brasil.jpg')); ?>">
...
<?php echo $__env->make('navegador', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/mynameistravel/resources/views/home.blade.php ENDPATH**/ ?>